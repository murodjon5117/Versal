...
public class YukchiHaqi extends AppCompatActivity {
    ...
    public void Load(){
        JsonObjectRequest jsonObjectRequest=new JsonObjectRequest(Request.Method.GET, "http://128.199.96.180/api/First/qarzdorlik/", null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    JSONArray jsonArray = response.getJSONArray("yukchilar");
                    ...
                    textView.setText("Yukchilar jami haqlari - "+kerakli.summa(String.valueOf(summa))+" so'm");
